                ...
                <div class="inner-content">
                    ...
                    <div class="breadcrumb-menu" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="500">
                        <ul>
                            ...
                            <li class="active">Fixed Deposit Account</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="statistics-content-box-style2">
                    ...
                    <div class="progress-block">
                        ...
                        <div class="inner-text count-box">
                            ...
                            <p>A Fixed Deposit Account offers secure savings with a fixed tenure and guaranteed returns.</p>
...
<section id="benefits" class="benefits-style2-area">
    <div class="container">
        <div class="sec-title text-center">
            <h2>Our Fixed Deposit Account Benefits</h2>
            <div class="sub-title">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="eligibility-img-box">
                    <div class="sec-title">
                        <h2>Eligibility to <br>Open Fixed Deposit Account</h2>
                        <div class="sub-title">
                            <p>Eligibility parameters for FDA.</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="eligibility-content-box">
                    ...
                    <div class="facts-box-style2">
                        ...
                        <div class="inner-title">
                            <h3>FDA opened<br> in last year</h3>
                        </div>
                    </div>
...
<section id="required" class="documents-area">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <div class="sub-title">
                <p>Basic documents required for opening a Fixed Deposit Account.</p>
            </div>
        </div>
        <div class="row">
