                ...
                <div class="statistics-content-box-style2">
                    ...
                    <div class="progress-block">
                        ...
                        <div class="inner-text count-box">
                            ...
                            <p>A Salary Account is for monthly salaries with convenient access and extra benefits.</p>
...
<section id="benefits" class="benefits-style2-area">
    <div class="container">
        <div class="sec-title text-center">
            <h2>Our Salary Account Benefits</h2>
            <div class="sub-title">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="eligibility-img-box">
                    <div class="sec-title">
                        <h2>Eligibility to <br>Open Salary Account</h2>
                        <div class="sub-title">
                            <p>Eligibility parameters for salary account.</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="eligibility-content-box">
                    ...
                    <div class="facts-box-style2">
                        <div class="counting">
                            <h2 class="odometer" data-count="3.2">00</h2>
                            <span class="k">k</span>
                        </div>
                        <div class="inner-title">
                            <h3>salary account opened<br> in last year</h3>
                        </div>
                    </div>
...
<section id="required" class="documents-area">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <div class="sub-title">
                <p>Basic documents required for opening a Salary Account.</p>
            </div>
        </div>
        <div class="row">
