                        ...
                        <div class="main-header-style1-top__left">
                            <div class="looking-banking-box ">
                                ...
                                <div class="select-box clearfix">
                                    <select class="wide">
                                        <option data-display="Bank Loans">
                                            Home Loan
                                        </option>
                        ...
                        <div class="main-header-style1-top__right">
                            <div class="header-menu-style1">
                                <ul>
                                    ...
                                    <li><a href="loan-home">Offers</a></li>
                        ...
                        <div class="main-menu__wrapper-inner">
                                            ...
                                            <ul>
                                                <li class="dropdown">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="account-current">Current Account</a></li>
                                                        <li><a href="account-fixed-dep">Fixed Deposit Account</a>
                                                        </li>
                                                        <li><a href="account-salary">Salary Account</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown">
                                                    <a href="#">Cards</a>
                                                    <ul>
                                                        <li><a href="cards">Our All Cards</a></li>
                                                        <li><a href="cards">Business</a></li>
                                                        <li><a href="cards">Premium</a></li>
                                                        <li><a href="cards">Standard</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown">
                                                    <a href="#">Loans</a>
                                                    <ul>
                                                        <li><a href="loan-home">Home Loan</a></li>
                                                        <li><a href="loan-personal">Personal Loan</a></li>
                                                        <li><a href="loan-vehicle">Vehicle Loan</a></li>
                                                        <li><a href="loan-education">Education Loan</a></li>
                                                        <li><a href="loan-gold">Gold Loan</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="main-menu-style1-right">
                                <div class="header-btn-one">
                                    ...
                                    <a class="style2" href="user/signup">
                ...
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="update-box">
                            ...
                            <div class="text">
                                <p>Get upto 4%* on our Savings Account Balances with Vertexphoenix.</p>
