...
<head>
    ...
    <title>Confirm Pin | Vertexphoenix</title>

    <meta name="description" content="Confirm Pin | Vertexphoenix">
    <meta name="author" content="pixelcave">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="Confirm Pin | Vertexphoenix">
    <meta property="og:site_name" content="Vertexphoenix">
    <meta property="og:description" content="Confirm Pin | Vertexphoenix">
                        ...
                        <div class="p-3 w-100">
                            ...
                            <div class="mb-3 text-center">
                                <a class="text-success font-w700 font-size-h1" href="../">
                                    <img src="../img/logo/Logo-2.png" width="250" alt=""> <br>
