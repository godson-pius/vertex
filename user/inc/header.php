...
if (!isset($_SESSION['user'])) {
    blockUrlHackers($_SESSION['user'], "signin");
} else {
...
<head>
    ...
    <meta name="description" content="This is user dashboard for Vertexphoenix customers">
    ...
    <meta property="og:description" content="This is user dashboard for Vertexphoenix customers">
        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="smini-hidden">
                <div class="content-header justify-content-lg-center bg-header-dark">
                    <!-- Logo -->
                    <a class="font-w600 text-white tracking-wide" href="index.html">
                        Royal<span class="opacity-75"> Union</span>
